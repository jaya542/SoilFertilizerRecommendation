...
public class SoilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_4_soil);
        ...
        if (yield != null) {
            ...
            yield.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    Toast.makeText(SoilActivity.this, getString(R.string.selected_yield) + " " + yieldNames[position], Toast.LENGTH_SHORT).show();
                }
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View b) {
                ...
                Intent intent = new Intent( SoilActivity.this , StartActivity.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View b) {
                ...
                Intent packageContext;
                Intent intent = new Intent( SoilActivity.this , DetailsActivity.class);
                startActivity(intent);
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View b) {
                ...
                ocValue = "Organic Carbon(%):  "+oc.getText().toString();
                phValue = "pH:  "+ph.getText().toString();
                ecValue = "EC(dS/m): "+ec.getText().toString();
                nValue = "Available Nitrogen(kg/ha):  "+n.getText().toString();
                pValue = "Available Phosphorus(kg/ha):  "+p.getText().toString();
                kValue = "Available Potassium(kg/ha):  "+k.getText().toString();
                yieldTarget = "Yield Target(q/ha):  "+yield.getSelectedItem().toString();

                Float om = Float.parseFloat(oc.getText().toString());
                String oc1;
                if(om <= 0.4){
                    oc1 = "Organic manures:   2.5 t/ha or green manure";
                }else {
                    oc1 = "Organic manures:  -----  ";
                }
                ...
                int tn11 = N/4;
                String tn = "Nitrogen(N):  "+String.valueOf(tn11);

                int tp11 = P;
                String tp = "Phosphorous(P₂O₅):  "+String.valueOf(tp11);

                int tk11 = K/4;
                String tk = "Potassium(K₂O):  "+String.valueOf(tk11);

                int tn12 = N/2;
                String tn1 = "Nitrogen(N):  "+String.valueOf(tn12);

                int tk12 = K/2;
                String tk1 = "Potassium(K₂O):  "+String.valueOf(tk12);
                ...
                Intent intent2 = new Intent( SoilActivity.this , OutputActivity.class);
                //Farmer Details
