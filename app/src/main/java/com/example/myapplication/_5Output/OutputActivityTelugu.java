...
public class OutputActivityTelugu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_5_output_telugu);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View b) {
                ...
                Intent intent = new Intent( OutputActivityTelugu.this , StartActivityTelugu.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View b) {
                ...
                Intent packageContext;
                Intent intent = new Intent( OutputActivityTelugu.this , DetailsActivityTelugu.class);
                startActivity(intent);
            }
        });
